...
void run() {
    ...
    /* Create CalcController and add all of its endpoints to router */
    auto controller = std::make_shared<CalcController>();
    ...
    OATPP_LOGI("MathParser", "Server running on port %s", connectionProvider->getProperty("port").getData());
