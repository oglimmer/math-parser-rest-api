 ...
 */
    OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::swagger::DocumentInfo>, swaggerDocumentInfo)([] {
        ...
        builder
                .setTitle("Mathematical Function Parser Service")
                .setDescription("A REST API to parse and resolve math functions. Written in C++ with oat++.")
                .setVersion("1.0")
                .setContactName("Oli Zimpasser")
                .setContactUrl("https://math.oglimmer.de")

                .setLicenseName("Apache License, Version 2.0")
                .setLicenseUrl("http://www.apache.org/licenses/LICENSE-2.0")

                .addServer("https://math.oglimmer.de", "server on oglimmer.de")
